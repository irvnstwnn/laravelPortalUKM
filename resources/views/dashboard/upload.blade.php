   ...
   @include('navbar.index')
    ...
    <div class="container mb-5">
        <section class="form-daftar m-auto mt-5">
            ...
            <form method="POST" action="/upload/berita" class="mt-5 d-flex justify-content-center" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-outline mb-4">
                    ...
                    <textarea style="border: 1px solid #000000;" name="isi" id="form2Example2" class="form-control"></textarea>
                </div>
